...
process loadImages {
    ...
    aws s3 ls ${params.image_dir} --recursive | grep .jpg | awk '{print "s3://" \$4}' > image_paths.txt
    """
}
...
process convertToGrayscale {
    ...
    python3 ${projectDir}/scripts/process_image.py \${image_file} \${output_file}
...
process addWatermark {
    ...
    python3 ${projectDir}/scripts/add_watermark.py \${image_file} \${output_file}
